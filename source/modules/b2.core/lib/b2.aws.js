...
B2.AWS.prototype.lambda = {
  ...
  invokeSyncWithCredentials: function (arn, credentials, params, callback) {
    ...
    B2.util.log.debug("credentials.AccessKeyId: " + credentials.Credentials.AccessKeyId, { line: __line });
    B2.util.log.debug("credentials.secretAccessKey: " + credentials.Credentials.SecretAccessKey, { line: __line });
    B2.util.log.debug("credentials.sessionToken: " + credentials.Credentials.SessionToken, { line: __line });
