def slot_types(language):
    slot_type_values = {
        "English": [{'sampleValue': {'value': 'cleaning'}}, {'sampleValue': {'value': 'root canal'}}, {'sampleValue': {'value': 'whitening'}}],
        "French": [{'sampleValue': {'value': 'nettoyage'}}, {'sampleValue': {'value': 'traitement du canal radiculaire'}}, {'sampleValue': {'value': 'blanchiment'}}],
        "Italian": [{'sampleValue': {'value': 'pulizia'}}, {'sampleValue': {'value': 'devitalizzazione'}}, {'sampleValue': {'value': 'blanchiment'}}],
        "Spanish": [{'sampleValue': {'value': 'limpieza'}}, {'sampleValue': {'value': 'endodoncia'}}, {'sampleValue': {'value': 'blanqueamiento'}}],
        "German": [{'sampleValue': {'value': 'Reinigung'}}, {'sampleValue': {'value': 'Wurzelbehandlung'}}, {'sampleValue': {'value': 'Weißen'}}],
    }
    return slot_type_values[language]

def utterances(language):
    utterance_values = {
        "English": [{'utterance': 'I would like to book an appointment'}, {'utterance': 'Book an appointment'}, {'utterance': 'Book a {AppointmentType}'}],
        "French": [{'utterance': 'Je souhaiterais prendre rendez-vous'}, {'utterance': 'Prendre rendez-vous'}, {'utterance': 'Réserver un {AppointmentType}'}],
        "Italian": [{'utterance': 'Vorrei fissare un appuntamento'}, {'utterance': 'Fissa un appuntamento'}, {'utterance': "Prenota un'operazione di {AppointmentType}"}],
        "Spanish": [{'utterance': 'Querría pedir una cita'}, {'utterance': 'Reservar una cita'}, {'utterance': "Pedir cita para {AppointmentType}"}],
        "German": [{'utterance': 'Ich möchte einen Termin buchen.'}, {'utterance': 'Einen Termin buchen'}, {'utterance': "Einen Termin des Typs {AppointmentType} buchen"}],
    }
